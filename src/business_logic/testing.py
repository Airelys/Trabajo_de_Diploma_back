...
from algorithms.classical_methods import *
...
sol = ClassicalMethods('CG',si,read2('backend/src/business_logic/Cuba_Datos_CoVid19_2022.xlsx','Hoja1',[2,3,8]),1000)
a = sol.solve()
si.print_numeric_solve([0,50],a,1000)
print(a)

'''sol2 = PSO(si,read2('backend/src/business_logic/Cuba_Datos_CoVid19_2022.xlsx','Hoja1',[2,3,8]),1000)
a2 = sol2.solve()
